...
set sf=0
choice /m 是否缩放
if %errorlevel%==1 (set /p c=长:
set /p k=宽:
set sf=1)
set bs=0
choice /m 是否变速
if %errorlevel%==1 (set /p m=PTS*
set bs=1)
set sc=<nul
set sp=<nul
:P
